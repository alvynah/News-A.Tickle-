...
class SourcesTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        '''
        self.new_article = Articles("abc-news","ABC NEWS", "ZEKE MILLER, AAMER MADHANI and JULIE WATSON Associated Press", "After outcry, Biden plans to lift refugee cap in May", "After outcry, Pres. Biden plans to lift the refugee cap in May.", "https://abcnews.go.com/Politics/wireStory/outcry-biden-plans-lift-refugee-cap-77147056",
